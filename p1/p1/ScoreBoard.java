...
public class ScoreBoard {
	...
	*/
	public static void main(String args[]){
		...
		System.out.println(board.combine(another, false));
		System.out.println(board.getPlayer(0).equals(player2));
		System.out.println(board.getPlayer(1).equals(player3));
		System.out.println(board.getPlayer(2).equals(player1));
